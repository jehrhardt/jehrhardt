...
- **🦀 Rust** - For rock solid stuff
- **🐍 Python** - For the joy of automating everything
...
- **📦 [mcpkg](https://github.com/jehrhardt/mcpkg)** - a package manager for model context of AI agents
